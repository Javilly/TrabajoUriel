...
public class PoolManager : MonoBehaviour
{
...

    {
        ...
        public GameObject PoolRequest(Vector3 pos, Vector3 rotation)
        {
        ...
        private void InitializeObject(GameObject objectToInitialize, Vector3 pos, Vector3 rotation)
        {
        ...
        public void DeletePoolObject(int posArrayPool)
        {
            PoolObjectDelete(myArray[posArrayPool]);
            return;
        }
    ...
    public void DeleteObjectFromPool(string poolName, int posArrayPool)
    {

        SearchPoolForName(poolName).DeletePoolObject(posArrayPool);
